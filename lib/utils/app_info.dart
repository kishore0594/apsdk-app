...
class AppInfo {
  ...
  static const String buildDate = 'September 21, 2026 (website content editor, product pages, badges)';
  ...
  /// e.g. "v1.23.1 · September 21, 2026 (website content editor, product pages, badges)"
